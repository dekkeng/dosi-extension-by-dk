...
async function get_floor_price(filter, order = 'PRICE_ASC') {  
    ...
    switch (filter) {
        ...
        case 'roborex':
            ...
            break;
        case 'shibainu':
            str = "propertyIds=16633703&"
            break;
        case 'alpaca':
            str = "propertyIds=17241718&"
            break;
        case 'glizzly':
            str = "propertyIds=17697031&"
            break;
        case 'pig':
  ...
  $(profile_container).append("<div class='dk-dosi-profile-container'>"+
            ...
            "<tbody>"+
                ...
                "<tr id='dk_floor_lutino'>"+
                    ...
                    "<td align='right' class='usd'>"+loading_image+"</td>"+
                "</tr>"+
                "<tr id='dk_floor_shibainu'>"+
                    "<td align='left'>"+
                      "<a href='https://citizen.store.dosi.world/en-US/marketplace?pageNo=1&collectibleId=2&propertyIds=16633703&category=&nftOrder=PRICE_ASC&currency=' target='_blank'>"+
                          "Shiba Inu"+
                      "</a>"+
                    "</td>"+
                    "<td align='right' class='owned'>"+loading_image+"</td>"+
                    ...
                    "<td align='right' class='usd'>"+loading_image+"</td>"+
                "</tr>"+
                "<tr id='dk_floor_alpaca'>"+
                    "<td align='left'>"+
                      "<a href='https://citizen.store.dosi.world/en-US/marketplace?pageNo=1&collectibleId=2&propertyIds=17241718&category=&nftOrder=PRICE_ASC&currency=' target='_blank'>"+
                          "Alpaca"+
                      "</a>"+
                    "</td>"+
                    "<td align='right' class='owned'>"+loading_image+"</td>"+
                    ...
                    "<td align='right' class='usd'>"+loading_image+"</td>"+
                "</tr>"+
                "<tr id='dk_floor_glizzly'>"+
                    "<td align='left'>"+
                      "<a href='https://citizen.store.dosi.world/en-US/marketplace?pageNo=1&collectibleId=2&propertyIds=17697031&category=&nftOrder=PRICE_ASC&currency=' target='_blank'>"+
                          "Glizzly"+
                      "</a>"+
                    "</td>"+
                    "<td align='right' class='owned'>"+loading_image+"</td>"+
                ...
                "<tr id='dk_floor_pig'>"+
                    "<td align='left'>"+
                      "<a href='https://citizen.store.dosi.world/en-US/marketplace?pageNo=1&collectibleId=2&propertyIds=18689255&category=&nftOrder=PRICE_ASC&currency=' target='_blank'>"+
                          "Pig"+
                      "</a>"+
                    "</td>"+
                    "<td align='right' class='owned'>"+loading_image+"</td>"+
...
async function generate_dosi_report(url = '') {
  ...
  if(profile_id) {
      ...
      gen_floor_price_text(data.summary['Shiba Inu'], selling.summary['Shiba Inu'], "shibainu");
